...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		bgFade = new FlxSprite(-200, -200).makeGraphic(Std.int(FlxG.width * 1.3), Std.int(FlxG.height * 1.3), 0xFF420D36);
		...
		switch (curCharacter)
		{
			...
			case 'pitroconfuso':
				...
				if (!portraitRight.visible)
				{
					...
					portraitRight.frames = Paths.getSparrowAtlas('dialogueshit/pitro2', 'shared');
					portraitRight.animation.addByPrefix('enter', 'portrait enter', 24, false);
			...
			case 'pitrotriste':
				...
				if (!portraitRight.visible)
				{
					...
					portraitRight.visible = true;
					portraitRight.frames = Paths.getSparrowAtlas('dialogueshit/pitro3', 'shared');
					portraitRight.animation.addByPrefix('enter', 'portrait enter', 24, false);
					portraitRight.animation.play('enter');
				}
			case 'pitro':
			...
			case 'core':
				...
				if (!portraitRight.visible)
				{
					...
					portraitRight.visible = true;
					portraitRight.frames = Paths.getSparrowAtlas('dialogueshit/core', 'shared');
					portraitRight.animation.addByPrefix('enter', 'portrait enter', 24, false);
					portraitRight.animation.play('enter');
				}
			case 'corecarinha':
				...
				if (!portraitRight.visible)
				{
					...
					portraitRight.visible = true;
					portraitRight.frames = Paths.getSparrowAtlas('dialogueshit/core2', 'shared');
					portraitRight.animation.addByPrefix('enter', 'portrait enter', 24, false);
					portraitRight.animation.play('enter');
				}
			case 'coretroll':
				...
				if (!portraitRight.visible)
				{
					...
					portraitRight.visible = true;
					portraitRight.frames = Paths.getSparrowAtlas('dialogueshit/core3', 'shared');
					portraitRight.animation.addByPrefix('enter', 'portrait enter', 24, false);
					portraitRight.animation.play('enter');
				}
			case 'none':
